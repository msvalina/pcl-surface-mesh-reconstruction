...
\caption[description for List of Figures]{%
    Oblak točaka \textit{table\_scene}\footnotemark[3] prije i poslije %
    \texttt{downsample()} funkcije}
\label{fig:tablescene-downsample}
\end{figure}

\footnotetext[3]{Oblak točaka \texttt{table\_scene\_lms400.pcd} je
objavljen pod uvijetima BSD licence - 
\href{https://github.com/PointCloudLibrary/data/blob/master/tutorials/table\_scene\_lms400.pcd}{izvor}}
